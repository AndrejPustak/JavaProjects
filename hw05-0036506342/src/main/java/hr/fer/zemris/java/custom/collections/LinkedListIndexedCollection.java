...
public class LinkedListIndexedCollection<E> implements List<E>{
	 ...
	 *
	 */
	private static class LinkedElementsGetter<V> implements ElementsGetter<V>	{
		
		ListNode node;
		private LinkedListIndexedCollection<V> col;
		 ...
		 */
		public LinkedElementsGetter(LinkedListIndexedCollection<V> col) {
			this.col = col;
	...
	public ElementsGetter<E> createElementsGetter() {
		return new LinkedElementsGetter<E>(this);
	}
