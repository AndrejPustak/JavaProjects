...
/**
 * This class represents an action which copies the selected text to the clipboard
 * @author Andrej
 *
 */
public class CopyTextAction extends DefaultEditorKit.CopyAction {
	 ...
	 */
	public CopyTextAction(JNotepadPP frame, String key) {
		this.frame = frame;
		this.key = key;
