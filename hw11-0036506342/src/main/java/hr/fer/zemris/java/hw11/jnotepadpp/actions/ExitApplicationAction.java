...
/**
 * This class represents an action which exits the application
 * @author Andrej
 *
 */
public class ExitApplicationAction extends AbstractAction {
	 ...
	 */
	public ExitApplicationAction(JNotepadPP frame, String key) {
		this.frame = frame;
		this.key = key;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(frame.checkIfModified()) {
			int button = JOptionPane.YES_NO_OPTION;
			int result = JOptionPane.showConfirmDialog(frame, frame.getFLP().getString("notSavedApp"), frame.getFLP().getString("confirm"), button);
