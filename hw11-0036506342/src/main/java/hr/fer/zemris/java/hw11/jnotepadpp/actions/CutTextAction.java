...
/**
 * This class represents an action which cuts the selected text to the clipboard
 * @author Andrej
 *
 */
public class CutTextAction extends DefaultEditorKit.CutAction{
	 ...
	 */
	public CutTextAction(JNotepadPP frame, String key) {
		this.frame = frame;
		this.key = key;
